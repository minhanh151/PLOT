...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PLOTPP.M = 4 # number of vision prompts
    cfg.TRAINER.PLOTPP.PRETRAIN_DIR = "" # the directory of the pre-trained model obtained after the first stage training
    cfg.TRAINER.PLOTPP.MODEL_UPD = "" # 'visual' (1st stage) or 'joint' (2nd stage), 'visual' means fixing the text prompt only update the visual prompt, 'joint' means update both
    cfg.TRAINER.PLOTPP.N_CTX_V = 2 # # number of vision context tokens
